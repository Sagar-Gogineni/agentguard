...
- Renamed PyPI package to `agentguard-eu` (import name remains `agentguard`)
- Fixed misleading claim in README problem statement
- Fixed FastAPI example deprecation warning (`on_event` → `lifespan`)
- Fixed lint errors and applied consistent ruff formatting
...
[0.1.1]: https://github.com/Sagar-Gogineni/agentguard/releases/tag/v0.1.1
